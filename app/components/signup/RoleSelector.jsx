...
export default function RoleSelector({onSend}) {
  ...
  return (
    <div className={styles.signupContainer}>
      ...
      {!selectedRole && (
        <div className={styles.signupContainer}>
          <div className={styles.itemContainer} onClick={() => handleUserChoise('user')}>
            <p className={styles.signUpItems}>USER</p>
            <p className={styles.signUpItemsDescription}>Lorem ipsum dolor sit amet consectetur. Diam amet sed eget in magna lacus.</p>
            </div>
          <div className={styles.itemContainer} onClick={() => handleUserChoise('company')}><p className={styles.signUpItems}>COMPANY</p>
          <p className={styles.signUpItemsDescription}>Lorem ipsum dolor sit amet consectetur. Diam amet sed eget in magna lacus.</p>
          </div>
          <div className={styles.itemContainer} onClick={() => handleUserChoise('organization')}><p className={styles.signUpItems}>ORGANIZATION</p>
          <p className={styles.signUpItemsDescription}>Lorem ipsum dolor sit amet consectetur. Diam amet sed eget in magna lacus.</p>
          </div>
        </div>
      )}
