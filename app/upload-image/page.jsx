...
import { faChevronRight, faCamera, faForward } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className={styles.uploadContainer}>
            <div className={styles.titleBar}>
                <FontAwesomeIcon icon={faClose} size="sm" className={styles.closeIcon} />
                <h2 className={styles.barTitle}>Upload dit billede</h2>
                <Link
                    className={styles.nextButton} href={'/image-upload-info'}>
                    {imageUrl !== null && (
                        <FontAwesomeIcon icon={faForward} size='2x' className={styles.nextIcon} />
                    )}
                </Link>
            </div>
            <div className={styles.imageContainer} onChange={handleImageChange} style={{
                backgroundImage: imageUrl ? `url(${imageUrl})` : 'none',
                backgroundSize: 'cover',
                backgroundPosition: 'center',
            }}>
                {imageUrl === null && (
                    <FontAwesomeIcon icon={faImage} size='4x' className={styles.imageIcon} />
                )}
            </div>
            <div className={styles.uploadFunctionContainer}>
                <div className={styles.uploadFuncBar}>
                    <div className={styles.UploadTextIconContain}>
                        ...
                        <Link href={'/'}>  <FontAwesomeIcon icon={faChevronRight} size='5xs' className={styles.uploadImageRight} /> </Link>

                    </div>
                    <div className={styles.uploadButtons}>
                        <label className={styles.uploadImagesIcon}>
                            <FontAwesomeIcon icon={faImages} size='2x' className={styles.uploadImagesIcon} /><input
                                type="file"
                                accept="image/*"
                                style={{ display: 'none' }}
                        ...
                        <label className={styles.uploaCamera}>
                            <FontAwesomeIcon icon={faCamera} size='2x' className={styles.uploaCamera} />
                            <input
                                type="file"
                                accept="image/*"
                                capture="environment"
